...
cd "/mnt/d/nitc curriculum/sem4/OPERATING SYSTEM LAB/myexpos/spl"
...
cd  "/mnt/d/nitc curriculum/sem4/OPERATING SYSTEM LAB/myexpos/xsm"

./xsm --timer 7

cd "/mnt/d/nitc curriculum/sem4/OPERATING SYSTEM LAB/myexpos/stage8"
